...
public class SQLQueries {
    ...
    public static final String UPDATE_READARTICLE_QUERY = "update readarticle set rating = ? where article_id = ? and reader_id = ?";
    public static final String UPDATE_READER_QUERY = "update reader set name = ? where id = ?";
    public static final String UPDATE_READER_CREDENTIALS_QUERY = "update credential set password = ? where username = ?";
    ...
    public static final String DELETE_READARTICLE_QUERY = "delete from readarticle where reader_id = ? and article_id = ?";
